...
//         <div className="p-7">
//           <button onClick={() => navigate(-1)} className="text-slate-500 hover:text-slate-800 mb-6">
//             <ArrowLeft size={22} />
//           </button>

//           <h1 className="text-2xl font-bold text-slate-900 mb-1">{t("chooseLanguage.title")}</h1>
//           <p className="text-sm text-slate-500 mb-6">{t("chooseLanguage.subtitle")}</p>
...
//           <p className="text-xs text-slate-500 text-center">
//             {t("chooseLanguage.changeAnytime")}
//           </p>
//         </div>
//       </div>
//     </div>
...
const ENGLISH_GLOSS: Record<string, string> = {
  en: "English",
  hi: "Hindi",
  "hi-en": "Hinglish",
  bn: "Bengali",
    ...
    <div className="min-h-screen bg-slate-200 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-300 shadow-md overflow-hidden">
        ...
        <div className="p-7">
          ...
          <div className="grid grid-cols-2 gap-3 mb-7">
            {languages.map((lang) => (
              ...
              >
                ...
                <span className="font-semibold text-slate-800 text-base">{lang.label}</span>
                <span className="text-xs text-slate-500">{ENGLISH_GLOSS[lang.code] || lang.code}</span>
              </button>
            ))}
          </div>
          ...
          <p className="text-xs text-slate-500 text-center">{t("chooseLanguage.changeAnytime")}</p>
        </div>
      </div>
    </div>
  );
