      ...
      <div className="w-full max-w-md bg-white rounded-2xl border border-slate-300 shadow-md overflow-hidden">
        ...
        <div className="p-7">
          ...
          <div className="grid grid-cols-2 gap-3 mb-7">
            {languages.map((lang) => (
              <button
                ...
                className={`relative flex flex-col items-start gap-1 rounded-xl border p-4 text-left transition cursor-pointer ${
                  language === lang.code
          ...
          <button
            ...
            className="w-full bg-green-800 text-white rounded-lg py-3.5 text-base font-semibold hover:bg-green-900 transition mb-3 cursor-pointer"
          >
