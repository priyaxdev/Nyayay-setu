...
//           <p className="text-sm text-slate-500 mb-6">Let's get you registered on NyayaySetu</p>
        ...
        <div className="p-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <label className="flex items-start gap-2 text-xs text-slate-600 cursor-pointer">
              ...
              <span>
                {t("auth.agreeToText")}{" "}
                <span className="text-green-800 font-medium">{t("auth.termsAndConditions")}</span> {t("auth.andText")}{" "}
                <span className="text-green-800 font-medium">{t("auth.privacyPolicy")}</span>
              </span>
            </label>
          ...
          <p className="text-center text-xs text-slate-400 mt-3">
            {t("auth.policeOfficerText")}{" "}
            <button
              onClick={() => navigate("/police/signup")}
              className="text-green-800 underline cursor-pointer"
            >
              {t("auth.registerHereInstead")}
            </button>
          </p>
        </div>
      </div>
