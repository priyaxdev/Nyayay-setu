...
//       navigate("/police/dashboard");
//     } catch (err) {
//       setError(err instanceof Error ? err.message : t("auth.loginFailedError"));
//     } finally {
//       setLoading(false);
//     }
//   };
...
//               <ShieldCheck className="text-white" size={18} />
//             </div>
//             <h1 className="text-2xl font-bold text-slate-900">{t("auth.policePortal")}</h1>
//           </div>
//           <p className="text-sm text-slate-500 mb-6">{t("auth.policePortalSubtitle")}</p>
